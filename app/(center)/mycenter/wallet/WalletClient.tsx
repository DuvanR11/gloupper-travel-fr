...
import { Dropdown, DropdownFilter } from '@/components/ui/dropdown';
...
const WalletClient: FC<WalletClientProps> = ({ tours, center }) => {
  ...
  const dropdownOptions = [
    { id: 'completado', label: 'Completado', count: 56 },
    { id: 'cancelado', label: 'Cancelado', count: 56 },
    { id: 'en-progreso', label: 'En progreso', count: 56 },
    { id: 'en-revision', label: 'En revision', count: 97 },
  ];
      ...
      <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        ...
        <div className="items-center justify-between lg:flex">
          <div className="mb-4 lg:mb-0">
            <h3 className="mb-2 text-xl font-bold text-gray-900 dark:text-white">Transacciones</h3>
            <span className="text-base font-normal text-gray-500 dark:text-gray-400">Visualiza tus ultimos movimientos</span>
          </div>
          ...
          <div>
            ...
            <div className="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="transactions-dropdown">
                ...
                <ul className="py-1" role="none">
                  <li>
                    <span className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Yesterday</span>
                  </li>
                  <li>
                    <span className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Today</span>
                  </li>
                  <li>
                    <span className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Last 7 days</span>
                  </li>
                  <li>
                    <span className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Last 30 days</span>
                  </li>
                  <li>
                    <span className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Last 90 days</span>
                  </li>
                </ul>

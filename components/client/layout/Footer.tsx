    ...
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="lg:flex lg:items-start lg:gap-8">
        ...
        >
          <div className="col-span-2">
            <div>
              ...
              <p className="mt-4 text-gray-500">
                Todo lo relacionado con turismo se el primero en conocer las tendencias
              </p>
            </div>
          </div>
            ...
            <form className="w-full">
              ...
              >
                <input
                  type="email"
                  id="UserEmail"
                  placeholder="andrestravel@gmail.com"
                  className="w-full border-none focus:border-transparent focus:ring-transparent sm:text-sm"
                />

                <button
                  className="mt-1 w-full bg-cyan-600 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
                >
                  Inscribirme
                </button>
              </div>
          ...
          <div className="col-span-2 sm:col-span-1">
            <p className="font-medium text-gray-900">Compañia</p>
          ...
          <div className="col-span-2 sm:col-span-1">
            <p className="font-medium text-gray-900">Enlaces utiles</p>
      ...
      <div className="mt-8 border-t border-gray-100 pt-8">
        <div className="sm:flex sm:justify-between">
          <p className="text-xs text-gray-500">
            &copy; 2023. Grupo Gloupper. Reservados todos los derechos.
          </p>
